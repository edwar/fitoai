...
const Hero = ({ goToCamera }: Props) => {
  return (
    <section className=''>
        <div className='grid wrapper pb-8 pt-20 lg:pb-8 lg:pt-30 lg:grid-cols-12'>
            <div className='flex w-full flex-col justify-center items-center lg:mr-auto lg:place-self-center lg:justify-start lg:items-start lg:col-span-8 lg:mt-10'>
                ...
                <p className='max-w-2xl text-center lg:text-left mb-6 font-light lg:mb-8 lg:text-lg text-gray-400'>
                ...
                <div className='w-full mb-6'>
                    <YouTube videoId="zIn69z4Pwak?si=OWv7P3_e-jj-mV0P" />
                </div>
                <button 
                    onClick={goToCamera} 
            ...
            <div className='hidden lg:mt-10 lg:col-span-4 lg:flex'>
