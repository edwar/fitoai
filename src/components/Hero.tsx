...
const Hero = ({ goToCamera }: Props) => {
  return (
    <section>
        <div className='grid wrapper px-4 pb-8 pt-20 lg:gap-8 xl:gap-0 lg:pb-8 lg:pt-30 grid-cols-12'>
            <div className='flex w-full flex-col justify-center items-center lg:mr-auto lg:place-self-center lg:justify-start lg:items-start col-span-full lg:col-span-7 lg:mt-10'>
                ...
                <p className='max-w-2xl text-center lg:text-left mb-6 font-light lg:mb-8 lg:text-xl text-gray-400'>
                ...
                <div className='w-full max-w-xl mx-0 mb-6'>
                    <iframe 
                        className='w-full rounded-lg shadow-lg size-80' 
            ...
            <div className='hidden lg:mt-10 col-span-full lg:col-span-5 lg:flex'>
