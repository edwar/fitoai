...
const Message = ({ message, close }: Props) => {
  return (
    message !== "" && <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 z-50 justify-center items-center md:inset-0 h-screen max-h-full">
