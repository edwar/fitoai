  ...
  return (
    <footer className='wrapper p-4 md:p-8 lg:p-10 '>
      <div className='text-center'>
          ...
          <p className='my-6 text-gray-400 bg-slate-900'>Aplicacion web potenciada con Inteligencia Artificial que ayuda con la identificación de plagas en los cultivos.</p>
